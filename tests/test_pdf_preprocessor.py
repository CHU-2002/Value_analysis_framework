...
class TestSectionKeywords:
    ...
    def test_all_nine_sections_present(self):
        assert set(SECTION_KEYWORDS.keys()) == {
            "P2", "P3", "P4", "P6", "P13", "MDA", "GOV", "MATTERS", "SUB"
        }

    def test_governance_sections_have_distinct_keywords(self):
        assert "公司治理" in SECTION_KEYWORDS["GOV"]
        assert "重要事项" in SECTION_KEYWORDS["MATTERS"]
